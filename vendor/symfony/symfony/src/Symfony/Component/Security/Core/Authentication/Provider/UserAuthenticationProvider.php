    ...
    public function authenticate(TokenInterface $token)
    {
        ...
        try {
            ...
            if ($this->hideUserNotFoundExceptions) {
                throw new BadCredentialsException('Le mot de passe est incorrect, essayer à nouveau !', 0, $notFound);
            }
        ...
        try {
            ...
            if ($this->hideUserNotFoundExceptions) {
                throw new BadCredentialsException('Le mot de passe est incorrect, essayer à nouveau !', 0, $e);
            }
