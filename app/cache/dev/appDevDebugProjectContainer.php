...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'opmwael', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\OPM\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\OPM\\PerdiemsBundle\\Entity')));
        ...
        $d->addDriver($b, 'OPM\\UserBundle\\Entity');
        $d->addDriver($b, 'OPM\\PerdiemsBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('OPMUserBundle' => 'OPM\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'OPMPerdiemsBundle' => 'OPM\\PerdiemsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7c5350f9c1cdfdbdbf32946a341b260acb858197c50a5c8645470962c7c7052c');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('OPM\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('OPM\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'OPM\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\OPM\\OPMBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\OPM\\OPMBundle/Resources/views'), 'OPMOPM');
        $instance->addPath(($this->targetDirs[3].'\\src\\OPM\\UserBundle/Resources/views'), 'OPMUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\OPM\\PerdiemsBundle/Resources/views'), 'OPMPerdiems');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OPMOPMBundle' => 'OPM\\OPMBundle\\OPMOPMBundle',
                'OPMUserBundle' => 'OPM\\UserBundle\\OPMUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'OPMPerdiemsBundle' => 'OPM\\PerdiemsBundle\\OPMPerdiemsBundle',
            ...
            'fos_user.model.user.class' => 'OPM\\UserBundle\\Entity\\User',
